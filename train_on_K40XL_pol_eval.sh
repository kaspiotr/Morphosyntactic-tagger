...
srun -n 1 -N 1 --ntasks-per-node=1 -A lemkingpu2 --partition=plgrid-gpu --gres=gpu:1 --mem-per-cpu=64GB --time=72:00:00 --mail-type=ALL --mail-user=kaspiotr@gmail.com python3 training_on_pol_eval_data.py
