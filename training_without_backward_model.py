...
from training import map_paragraph_id_to_text_category_name, write_to_file, _get_proposed_tag_str, _take_proposed_tag_tag, _get_unique_list_of_proposed_tags, _write_paragraph_to_file
import argparse
import os
import jsonlines
...
def train(skf_split_no, jsonl_file_path):
    ...
    that file
    """
    log.basicConfig(filename='resources/training_ex_1_' + str(skf_split_no) + '.log',
