...
echo {1..10} | xargs -t -P 10 -n 1 srun -n 1 -N 1 --ntasks-per-node=1 -A lemkingpu2 --partition=plgrid-gpu --gres=gpu:1 --mem-per-cpu=64GB --time=72:00:00 --mail-type=ALL --mail-user=kaspiotr@gmail.com python3 training_without_backward_model.py
