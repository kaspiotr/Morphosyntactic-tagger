 ...
 * **convert_nkjp_to_xml.py**:  
   ...
   Files *nkjp_ref_n.xml* are saved in resources directory of this project. To run this script you need to create a _nkjp_data_ directory in the main directory of this project.  
