...
def read_sentence_from_tsv(skf_split_no):
    with open("resources_ex_4/taggers/example-pos/it-" + skf_split_no + "/test.tsv") as fd:
...
def main():
    path = os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + "/resources_ex_4/taggers/example-pos/*/test.tsv"
